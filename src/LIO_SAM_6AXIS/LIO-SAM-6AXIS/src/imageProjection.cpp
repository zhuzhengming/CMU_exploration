...
public:
    ...
    void cloudHandler(const sensor_msgs::PointCloud2ConstPtr &laserCloudMsg) {
        std::cout<< "here is cloudHandler function"<<std::endl;
...
//                dst.time = (i % 2048) / 20480.0;
            ...
            std::cout<< "here is cachePointCloud function"<<std::endl;
        } else {
...
//              << ", " << imuRotZ[imuPointerCur - 1] << std::endl;
    ...
    void projectPointCloud() {
        std::cout<< "here is projectPointCloud function"<<std::endl;
...
//    std::cout << "point size raw: " << cloudSize << std::endl;
    ...
    void publishClouds() {
        std::cout<< "here is publishClouds function"<<std::endl;
